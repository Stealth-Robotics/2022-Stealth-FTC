        ...
        RoadRunnerBotEntity myBot = new DefaultBotBuilder(meepMeep)
                ...
                .followTrajectorySequence(drive ->
                        drive.trajectorySequenceBuilder(new Pose2d(-31, -62, Math.toRadians(90)))
                                ...
                                .splineToSplineHeading(new Pose2d(-52, -35, Math.toRadians(90)), Math.toRadians(90))
                                .strafeRight(29)
                                .lineToSplineHeading(new Pose2d(-31, -31, Math.toRadians(45)))
                                .waitSeconds(.5)
                                .back(.1)
                                .splineToSplineHeading(new Pose2d(-57, -35, Math.toRadians(180)), Math.toRadians(190))
