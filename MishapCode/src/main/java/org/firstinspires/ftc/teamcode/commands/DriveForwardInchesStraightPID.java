...
@Config
public class DriveForwardInchesStraightPID extends CommandBase {
    ...
    public DriveForwardInchesStraightPID(SimpleMecanumDriveSubsystem drive, double forward, double speed) {
        this.drive = drive;
