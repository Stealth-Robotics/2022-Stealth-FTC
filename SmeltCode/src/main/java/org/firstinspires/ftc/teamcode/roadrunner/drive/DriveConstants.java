...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(12, 0, 0, 14);
    ...
    public static double GEAR_RATIO = 1.142; // output (wheel) speed / input (motor) speed
