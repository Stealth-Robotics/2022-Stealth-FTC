...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(25, 0, 4, 15);
    ...
    public static double GEAR_RATIO = 0.9607; // output (wheel) speed / input (motor) speed
