...
public class DriveExperimentCommand extends CommandBase {
    ...
    public DriveExperimentCommand(SimpleMecanumDriveSubsystem drive, double forward) {
        this.drive = drive;
    ...
    public void initialize() {
        ...
        double driveSpeed = 1.0;  // Remember, the stick is backwards!
        if (!forwardDir) {
            driveSpeed *= -1.0;
        }
