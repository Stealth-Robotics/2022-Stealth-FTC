...
@Autonomous(name = "RED Right | Cycle Auto", group = "RED Auto", preselectTeleOp = "RED | Tele-Op")
        ...
        switch (camera.getID()) {
            case 0:
                return new SequentialCommandGroup(
                        ...
                        new WaitBeforeAuto(500, new InstantCommand(() -> grabber.closeGripper())),
                        new WaitBeforeAuto(1000, new InstantCommand(() -> grabber.setArmPositionUp())),
                        new WaitBeforeAuto(500, new FollowTrajectorySequence(drive, RedRightCycleAutoTrajectories.trajectory3)),
                        //  new HighPolePreset(extender, grabber,0),
                        new InstantCommand(() -> grabber.openGripper()),
                        // new ResetRobot(extender, grabber),
                      ...
                      //  new HighPolePreset(extender, grabber,0),
                        ...
                        new FollowTrajectorySequence(drive, RedRightCycleAutoTrajectories.trajectory6)
                );
            case 2:
                return new SequentialCommandGroup(
                        new InstantCommand(() -> grabber.closeGripper()),
                      ...
                      //  new HighPolePreset(extender, grabber,0),
                        ...
                        new FollowTrajectorySequence(drive, RedRightCycleAutoTrajectories.trajectory5)
