...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(6, 0.25, 0.5);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(3, 0.25, 0.5);

    public static double LATERAL_MULTIPLIER = 0.889;
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        follower = new HolonomicPIDVAFollower(TRANSLATIONAL_PID, TRANSLATIONAL_PID, HEADING_PID,
                new Pose2d(0.25, 0.25, Math.toRadians(2.0)), 0.25);
